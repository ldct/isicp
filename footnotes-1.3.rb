...
# Replaces footnote placeholders #49#..#66# in <content_file> with links
# and brings in the footnotes from <orig_file>

require 'nokogiri'

range = (49..66)  # footnote numbers in section 1.3

orig_file = File.open("book-Z-H-12.html")
orig_page = Nokogiri::HTML(orig_file)
orig_file.close

content_file = File.open("content/1-3-hop.content.old.html", "r")
content_page = content_file.read
content_file.close

new_file = File.open("content/1-3-hop.content.html", "w")
